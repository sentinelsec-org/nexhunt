...
def _build_registry() -> dict[str, "ToolAdapter"]:
    ...
    from nexhunt.adapters.graphql_audit import GraphqlAuditAdapter
    from nexhunt.adapters.viewstate_audit import ViewStateAuditAdapter
    from nexhunt.adapters.wpscan import WpscanAdapter
    ...
    from nexhunt.adapters.vhost_fuzzer import VhostFuzzerAdapter
    from nexhunt.adapters.lfi import LfiAdapter
    ...
    adapters = [
        ...
        GobusterDnsAdapter(), VhostFuzzerAdapter(),
        LfiAdapter(),
    ]
